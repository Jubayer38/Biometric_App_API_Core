...
namespace BIA.Entity.RequestEntity
{
    ...
    {
        public MnpPortInData data { get; set; }
        public MnpPortInMeta meta { get; set; }
    }

    public class MnpPortInData
    {
        public MnpPortInAttributes attributes { get; set; }
    ...
    {
        public MnpPortInCustomer customer { get; set; }
        public System.Collections.ArrayList products { get; set; }
        public MnpPortInSales_Info sales_info { get; set; }
    }
    ...
    public class MnpPortInProduct
    {
        ...
        public MnpPortInUser user { get; set; }
    ...
    public class MnpPortInProduct1
    {
        ...
        public MnpPortInData_Dict data_dict { get; set; }
