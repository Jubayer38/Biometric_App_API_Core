...
namespace BIA.Entity.RequestEntity
{
    ...
    {
        public NewRegUnPairData data { get; set; }
        public NewRegUnPairMeta meta { get; set; }
    }

    public class NewRegUnPairData
    {
        public string type { get; set; }
        public NewRegUnPairAttributes attributes { get; set; }
    }
    ...
    {
        public NewRegUnPairCustomer customer { get; set; }
        public NewRegUnPairSales_Info sales_info { get; set; }
    ...
    public class NewRegUnPairProduct
    {
        ...
        public NewRegUnPairPayer payer { get; set; }
        //public string user { get; set; }
        public NewRegUnPairUser user { get; set; }
    ...
    public class NewRegUnPairProduct1
    {
        ...
        public NewRegUnPairData_Dict data_dict { get; set; }
