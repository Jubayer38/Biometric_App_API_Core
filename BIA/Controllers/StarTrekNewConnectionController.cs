...
namespace BIA.Controllers
{
    ...
    public class StarTrekNewConnectionController : ControllerBase
    {
        ...
        public StarTrekNewConnectionController(BLLOrder orderManager, BLLLog bllLog, BiometricApiCall apiCall, GeoFencingValidation geo, StarTrekCommonController trekCommonController, BaseController bio, eShopAPICall eShopAPI, IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> NewConnectionSubmitOrder([FromBody] RAOrderRequestV2 model)
        {
            ...
            try
            {
                ...
                model.is_starTrek = 1;
                orderRes = await _orderManager.SubmitOrderV8(model, loginProviderId);
                if (orderRes.isError)
                {
                    return Ok(new RACommonResponseRevamp()
                    {
                ...
                try
                {
                    ...
                    if (model.is_paired == 0)
                    {
                        ...
                        {
                            RACommonResponseRevamp msisdnValidationResp = await _trekCommonController.ValidateUnpairedMSISDNSTartTrekV2(new UnpairedMSISDNCheckRequest()
                            {
                                mobile_number = model.msisdn,
                                sim_number = model.sim_number,
                                channel_id = channelInfo.Item1,
        ...
        public async Task<IActionResult> NewConnectionSubmitOrderV2([FromBody] CherishRequest model)
        {
            SendOrderResponseRev orderRes = new SendOrderResponseRev();
            SendOrderResponse2 response2 = new SendOrderResponse2();
            BIAToDBSSLog log = new BIAToDBSSLog();
        ...
        public async Task<IActionResult> NewConnectionSubmitOrder_Online([FromBody] RAOrderRequestV2 model)
        {
            SendOrderResponseRev orderRes = new SendOrderResponseRev();
            SendOrderResponse2 response2 = new SendOrderResponse2();
            BIAToDBSSLog log = new BIAToDBSSLog();
                    ...
                    if (model.is_paired == 0)
                    {
                        ...
                        if (responseModel != null)
                        {
                            if (responseModel.data != null)
                            {
                                ...
                                {
                                    RACommonResponseRevampResp2 msisdnValidationResp = await _trekCommonController.ValidateUnpairedMSISDNSTartTrekTestOnline(new UnpairedMSISDNCheckRequest()
                                    {
                                        mobile_number = model.msisdn,
                                        sim_number = model.sim_number,
                                        channel_id = channelInfo.Item1,
        ...
        public async Task<IActionResult> NewConnectionSubmitOrder_ESIM([FromBody] RAOrderRequestV2 model)
        {
            ...
            try
            {
                ...
                if (model.is_paired == 0)
                {
                    ...
                    {
                        RACommonResponseRevamp msisdnValidationResp = await _trekCommonController.ValidateUnpairedMSISDNESIMV2(new UnpairedMSISDNCheckRequest()
                        {
                            mobile_number = model.msisdn,
                            sim_number = model.sim_number,
                            channel_id = channelInfo.Item1,
        ...
        public async Task<IActionResult> NewConnectionSubmitOrder_ESIM_Online([FromBody] RAOrderRequestV2 model)
        {
            SendOrderResponseRev orderRes = new SendOrderResponseRev();
            SendOrderResponse2 response2 = new SendOrderResponse2();
            BIAToDBSSLog log = new BIAToDBSSLog();
