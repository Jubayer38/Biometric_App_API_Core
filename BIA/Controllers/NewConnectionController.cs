...
namespace BIA.Controllers
{
    ...
    public class NewConnectionController : ControllerBase
    {
        ...
        /// Send Order
        /// <summary>
        /// This API is used for NewConnection (Paired, Unpaired) of submit order.
        /// </summary>
        /// <param name="model"></param>
        /// <returns>Order request token id</returns>
        [HttpPost]
        [Route("NewConnectionSubmitOrderV1")]
        public async Task<IActionResult> NewConnectionSubmitOrderV1([FromBody] RAOrderRequest model)
        {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            if (verifyResp.Reservation_Id != null)
                            {
                                ...
                                {
                                   await _apiCall.UnreserveMSISDN(verifyResp.Reservation_Id, model.session_token, "", model.bi_token_number.ToString(), model.msisdn);
                                }
                            }
                            model.status = (int)EnumRAOrderStatus.Failed;
            ...
            finally
            {
                ...
                log.res_time = DateTime.Now;
                log.is_success = model.bi_token_number > 2 ? 1 : 0;
                log.res_blob = _blJson.GetGenericJsonData(orderRes);
                log.method_name = "NewConnectionSubmitOrderV1";
        ...
        [HttpPost]
        [Route("NewConnectionSubmitOrderV2")]
        public async Task<IActionResult> NewConnectionSubmitOrderV2([FromBody] RAOrderRequestV2 model)
        {
            SendOrderResponse orderRes = new SendOrderResponse();
            SendOrderResponse2 response2 = new SendOrderResponse2();
            BIAToDBSSLog log = new BIAToDBSSLog();
            ...
            finally
            {
                ...
                log.res_time = DateTime.Now;
                log.res_blob = _blJson.GetGenericJsonData(orderRes);
                log.method_name = "NewConnectionSubmitOrderV2";
                log.integration_point_from = Convert.ToDecimal(IntegrationPoints.RA);
                log.integration_point_to = Convert.ToDecimal(IntegrationPoints.BI);
                log.user_id = model.retailer_id;
                log.remarks = model.bi_token_number != null
        ...
        [HttpPost]
        [Route("NewConnectionSubmitOrderV3")]
        public async Task<IActionResult> NewConnectionSubmitOrderV3([FromBody] RAOrderRequestV2 model)
        {
            SendOrderResponse orderRes = new SendOrderResponse();
            SendOrderResponse2 response2 = new SendOrderResponse2();
            BIAToDBSSLog log = new BIAToDBSSLog();
            ...
            finally
            {
                ...
                log.res_time = DateTime.Now;
                log.res_blob = _blJson.GetGenericJsonData(orderRes);
                log.method_name = "NewConnectionSubmitOrderV3";
                log.integration_point_from = Convert.ToDecimal(IntegrationPoints.RA);
                log.integration_point_to = Convert.ToDecimal(IntegrationPoints.BI);
                log.user_id = model.retailer_id;
                log.remarks = model.bi_token_number != null
        ...
        public async Task<IActionResult> NewConnectionSubmitOrderV4([FromBody] RAOrderRequestV2 model)
        {
            ...
            try
            {
                ...
                if (model.purpose_number == "2" && String.IsNullOrEmpty(model.subscription_code))
                {
                    return Ok(new RACommonResponseRevamp()
                    {
                        isError = true,
                        message = "Technical error!!! subscription_code is missing, Please resubmit the request.",
                        data = new Datas()
                        {
                            isEsim = 0,
                            request_id = " "
        ...
        public async Task<IActionResult> NewConnectionSubmitOrderV5([FromBody] CherishRequest model)
        {
            SendOrderResponseRev orderRes = new SendOrderResponseRev();
            SendOrderResponse2 response2 = new SendOrderResponse2();
            BIAToDBSSLog log = new BIAToDBSSLog();
        ...
        [HttpPost]
        [Route("NewConnectionSubmitOrder_ESIM")]
        public async Task<IActionResult> NewConnectionSubmitOrder_ESIM([FromBody] RAOrderRequestV2 model)
        {
            SendOrderResponse orderRes = new SendOrderResponse();
            SendOrderResponse2 response2 = new SendOrderResponse2();
            BIAToDBSSLog log = new BIAToDBSSLog();
            ...
            finally
            {
                ...
                log.is_success = orderRes.request_id.Length > 1 ? 1 : 0;
                log.res_blob = _blJson.GetGenericJsonData(orderRes);
                log.method_name = "NewConnectionSubmitOrder_ESIM";
                log.integration_point_from = Convert.ToDecimal(IntegrationPoints.RA);
                log.integration_point_to = Convert.ToDecimal(IntegrationPoints.BI);
                log.user_id = model.retailer_id;
                log.remarks = model.bi_token_number != null
        ...
        public async Task<IActionResult> NewConnectionSubmitOrder_ESIMV2([FromBody] RAOrderRequestV2 model)
        {
            SendOrderResponseRev orderRes = new SendOrderResponseRev();
            SendOrderResponse2 response2 = new SendOrderResponse2();
            BIAToDBSSLog log = new BIAToDBSSLog();
        ...
        public async Task<IActionResult> NewConnectionSubmitOrder_ESIMV3([FromBody] CherishRequest model)
        {
            SendOrderResponseRev orderRes = new SendOrderResponseRev();
            SendOrderResponse2 response2 = new SendOrderResponse2();
            BIAToDBSSLog log = new BIAToDBSSLog();
