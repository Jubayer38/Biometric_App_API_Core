...
namespace BIA.Controllers
{
    ...
    public class CherishNewConnectionController : ControllerBase
    {
        ...
        public CherishNewConnectionController(BLLRAToDBSSParse raToDBssParse, BLLDBSSToRAParse dbssToRaParse, ApiRequest apiReq, BL_Json blJson, BLLOrder orderManager, BLLLog bllLog, BiometricApiCall apiCall, BaseController bio, GeoFencingValidation geo, IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> CherishNewConnection([FromBody] CherishRequest model)
        {
        ...
        public async Task<IActionResult> CherishNewConnectionESIM([FromBody] CherishRequest model)
        {
            SendOrderResponseRev orderRes = new SendOrderResponseRev();
            SendOrderResponse2 response2 = new SendOrderResponse2();
            BIAToDBSSLog log = new BIAToDBSSLog();
